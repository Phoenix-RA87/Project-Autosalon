...
OE1.Cells[1,1].Value:='Журнал продаж автомобилей'+
'За период'+' '+DateToStr(DateTimePicker1.Date)+' по '+' '+DateToStr(DateTimePicker2.Date);
OE1.Cells[2,1].Value:='№ Дог';
OE1.Cells[2,2].value:='ФИОПокуп';
OE1.Cells[2,3].Value:='ДатаPаключ';
OE1.Cells[2,4].Value:='Марка';
OE1.Cells[2,5].Value:='Модель';
OE1.Cells[2,6].Value:='БазЦена';
OE1.Cells[2,7].Value:='№ Двигателя';
OE1.Cells[2,8].Value:='№ Кузова';;
OE1.Cells[2,9].Value:='ДопОборуд на сумму р.';
OE1.Cells[2,10].Value:='Сумма';
OE1.Cells[2,11].Value:='Кол-во';
...
OE1.Range['A3:K'+IntToStr(istr+1)].Select;   // Выделить ячейки
...
writeln(f1,'<th>'+'ФИОПокуп'+'</th>');
writeln(f1,'<th>'+'ДатаЗаключ'+'</th>');
writeln(f1,'<th>'+'Марка'+'</th>');
writeln(f1,'<th>'+'Модель'+'</th>');
writeln(f1,'<th>'+'БазЦена'+'</th>');
writeln(f1,'<th>'+'№ Двигателя'+'</th>');
writeln(f1,'<th>'+'№ Кузова'+'</th>');
writeln(f1,'<th>'+'ДопОборуд на сумму р.'+'</th>');
writeln(f1,'<th>'+'Сумма'+'</th>');
...
procedure TRAJpa.BitBtn4Click(Sender: TObject);  // Диалоговое окно - Выход из программы.
begin
...
procedure TRAJpa.BitBtn5Click(Sender: TObject);  // Диалоговое окно - Закрытие формы программы.
begin
...
RADM.ADOQueryOtch.Open;
 ...
 DBGrid1.Columns.Items[0].Title.Caption :='№ Дог ';
  DBGrid1.Columns.Items[1].Title.Caption :='ФИОПокуп';
    DBGrid1.Columns.Items[2].Title.Caption :='ДатаЗаключ';
     DBGrid1.Columns.Items[3].Title.Caption :='Марка';
      DBGrid1.Columns.Items[4].Title.Caption :='Модель';
       DBGrid1.Columns.Items[5].Title.Caption :='БазЦена';
        DBGrid1.Columns.Items[6].Title.Caption :='№ Двигателя';
         DBGrid1.Columns.Items[7].Title.Caption :='№ Кузова';
          DBGrid1.Columns.Items[8].Title.Caption :='ДопОборуд на сумму р.';
           DBGrid1.Columns.Items[9].Title.Caption :='Сумма';
            DBGrid1.Columns.Items[10].Title.Caption :='Кол-во';
