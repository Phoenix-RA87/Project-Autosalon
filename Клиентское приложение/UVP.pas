...
begin
  if Length(Trim(LabeledEdit1.Text)) = 0 then
   begin
     MessageDlg('Вы не указали Наименование Поставщика!',mtError,[mbOk],0);
     Exit     //Выход
  end;
...
ShowMessage('Новый поставщик успешно добавлен.'); // Диалоговое окно.
...
procedure TRAVP.BitBtn4Click(Sender: TObject); // Диалоговое окно - Закрытие формы программы.
begin
...
procedure TRAVP.BitBtn5Click(Sender: TObject);  // Диалоговое окно - Выход из программы.
begin
