...
OE1.Cells[1,1].Value:='Журнал поступившей рекламации'+
'За период'+' '+DateToStr(DateTimePicker1.Date)+' по '+' '+DateToStr(DateTimePicker2.Date);
OE1.Cells[2,1].Value:='№ Рекламации';
OE1.Cells[2,2].value:='Дата рекламации';
OE1.Cells[2,3].Value:='№ Дог';
OE1.Cells[2,4].Value:='ФИО Покупателя';
OE1.Cells[2,5].Value:='№ Пост';
OE1.Cells[2,6].Value:='НаимПост';
OE1.Cells[2,7].Value:='Марка';
OE1.Cells[2,8].Value:='Модель';
OE1.Cells[2,9].Value:='Неисправность';
OE1.Cells[2,10].Value:='Результат';
OE1.Cells[2,11].Value:='Сумма Убытков';
...
writeln(f1,'<th>'+'№ Реклам'+'</th>');
writeln(f1,'<th>'+'ДатаРеклам'+'</th>');
writeln(f1,'<th>'+'№ Дог'+'</th>');
writeln(f1,'<th>'+'ФИО'+'</th>');
writeln(f1,'<th>'+'№ Пост'+'</th>');
writeln(f1,'<th>'+'НаимПост'+'</th>');
writeln(f1,'<th>'+'Марка'+'</th>');
writeln(f1,'<th>'+'Модель'+'</th>');
writeln(f1,'<th>'+'Неисправность'+'</th>');
writeln(f1,'<th>'+'Результат'+'</th>');
writeln(f1,'<th>'+'СуммаУбытков'+'</th>');
...
procedure TRAJpr.BitBtn4Click(Sender: TObject);
begin
...
procedure TRAJpr.BitBtn5Click(Sender: TObject);
begin
...
RADM.ADOQueryOtch.Open;
 ...
 DBGrid1.Columns.Items[0].Title.Caption :='№ Реклам';
  DBGrid1.Columns.Items[1].Title.Caption :='ДатаРеклам';
    DBGrid1.Columns.Items[2].Title.Caption :='№ Дог';
     DBGrid1.Columns.Items[3].Title.Caption :='ФИОПокуп';
      DBGrid1.Columns.Items[4].Title.Caption :='№ Пост';
       DBGrid1.Columns.Items[5].Title.Caption :='НаимПост';
        DBGrid1.Columns.Items[6].Title.Caption :='Марка';
         DBGrid1.Columns.Items[7].Title.Caption :='Модель';
          DBGrid1.Columns.Items[8].Title.Caption :='Неисправность';
           DBGrid1.Columns.Items[9].Title.Caption :='Результат';
            DBGrid1.Columns.Items[10].Title.Caption :='СуммаУбытков';
end;
